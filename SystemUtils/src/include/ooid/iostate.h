/********************************************************************\
 * iostate.h -- io state saver classes                              *
 *                                                                  *
 * Copyright (C) 2008 Kenneth Laskoski                              *
 *                                                                  *
\********************************************************************/
/** @file iostate.h
    @brief io state saver classes
    this classes save io states on construction
    and restore them on destruction, RAII style

    @author Copyright (C) 2008 Kenneth Laskoski
    slight modification of work by
    @author Copyright (C) 2002, 2005 Daryle Walker
